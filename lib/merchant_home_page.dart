...
class _MerchantHomePageState extends State<MerchantHomePage> {
  ...
  Future<DataSnapshot>? _merchantDataFuture;
  ...
  void _loadData() {
    if (_user != null) {
      setState(() {
        _merchantDataFuture =
            FirebaseDatabase.instance.ref('merchants/${_user.uid}').get();
        _transactionsFuture = FirebaseDatabase.instance
            .ref('merchants/${_user.uid}/transactions')
            .limitToLast(3)
            .get();
      });
    }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0,
        // NEW: Title now shows merchant name and is tappable
        title: FutureBuilder<DataSnapshot>(
          future: _merchantDataFuture,
        ...
        // NEW: Leading icon is the profile picture, also tappable
        leading: Padding(
            ...
            return Column(
              children: transactions.map((tx) {
                ...
                return _buildTransactionItem(
                  ...
                  color: Colors.green,
                  title: tx['studentName'] ?? 'From Student',
